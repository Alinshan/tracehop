...
With the **v1.1 Tracehop integrates a dedicated **Phase 0: Technical Intelligence** stage, a professional **PySide6 Desktop GUI**, and a 4-phase automated **Pentest Orchestration** engine.
